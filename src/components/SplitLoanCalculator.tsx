...
import { Calculator, Split, CreditCard } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-slate-600 dark:text-slate-300 max-w-3xl mx-auto mb-8">
            Calculate payments for single loans or split them into multiple tranches with different rates and terms
          </p>
